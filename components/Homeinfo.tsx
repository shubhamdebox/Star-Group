                ...
                <div className='max-w-7xl mx-auto '>
                    <div className='grid justify-center text-center relative '>
                        <div className={`text-sm lg:text-xl   px-5 ${techsans.className}`}>
                            <Toprightcorner/>
                            <span className='z-30'>{`Star Group is an amalgamation of flourishing endeavors that span across various sectors. 
...
Explore our network of ventures, each one unique, yet united under the umbrella of the Star Group.`}</span>
                        </div>
                    </div>
                </div>
            </div>
