...
export default function Services() {
  let data = [
    ...
    {
      logo: hotel,
      title: "Total hotel area",
      value: 185,
      symbol: "K",
      subtitle: "Square feet and growing...",
    },
    {
      logo: more,
      title: "More than ",
  ...
  return (
    <>
      <div className="bg-lightwhite   z-10 py-5 ">
        <div
          className={`max-w-7xl mx-auto grid justify-center pt-5 pb-2 text-4xl  lg:text-5xl ${myFont.className}`}
        >
          <p>{`Our story in numbers`}</p>
        </div>
        <div className="max-w-7xl mx-auto px-10   ">
          <div
            className="grid md:grid-cols-3 gap-8 justify-center text-center "
            data-aos="fade-up"
          >
            {data.map((value: any) => {
              return (
