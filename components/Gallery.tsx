  ...
  return (
    <div className='py-10'>
        <div className='max-w-7xl mx-auto grid justify-center text-center pb-10'>
                <span className={`${myFont.className} text-5xl`}>{`Gallery`}</span>
        </div>
            ...
            <Masonry columnsCount={3} gutter="5px">
              {data.map((image: any, i: any) => (
                ...
                <div key={i} className='relative group overflow-hidden'>
                  ...
                  />
                   <div className='absolute md:translate-y-10 bottom-0 text-black duration-300  group-hover:block group-hover:-translate-y-5 text-2xl font-bold left-4 '>
