...
export default function homegridcon() {
    ...
    return (
        <>
            <div className='bg-[#E1EBED] min-h-screen '>
                <div className="max-w-5xl mx-auto ">
                    <div className="md:grid md:grid-cols-2 grid px-5 md:px-0 py-20 gap-5 ">
                        ...
                        <div className="flex flex-col space-y-5 " >
                            ...
                            {data.map((data: any, index: any) => (
                                <>
                                    <div className="relative -z-0  group bg-primary/95 p-4 border-2 border-black shadow-[6px_8px_0px_0px_#1a202c]  text-white px-10 py-20" key={data.title}>
                                       
                                       <p className={` text-4xl ${myFont.className} `}>{data.title}</p>
                                   
                                       <div className='w-28 -z-10 group-hover:w-14 h-6 bg-bordercolor absolute left-20 group-hover:-translate-x-9 top-[100px] duration-300 '></div>
                                   <div className="py-10 text-lg  group-hover:translate-x-2 duration-150">
